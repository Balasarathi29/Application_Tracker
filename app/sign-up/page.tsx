        ...
        <Card className="w-full max-w-md border-gray-200 shadow-lg" >
            <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-gray-600">
                    Create an account to track your job applications and stay organized.
                </CardDescription>
            </CardHeader>
            <form className="space-y-4">
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input id="password" type = "password" placeholder="••••••••" required  className="border-gray-300 focus:border-primary focus:ring-primary"
                    /> 
                    </div>
                </CardContent>
