...
export default function SignIn() {
        ...
        async function handleSubmit(e : React.FormEvent<HTMLFormElement>) {
            ...
            try{
                ...
                if(result.error){
                    setError(result.error.message ?? "Failed to Login an account. Please try again.")
                } else {
                    router.push("/dashboard")
                }
            }catch(err){
                setError("Failed to Login an account. Please try again.")
            }finally{
                setLoading(false)
            }
        }
        ...
        <Card className="w-full max-w-md border-gray-200 shadow-lg" >
            <CardHeader className="space-y-1">
                ...
                <CardDescription className="text-gray-600">
                    welcome back! Please enter your credentials to access your job application tracker and stay organized.
                </CardDescription>
            </CardHeader>
